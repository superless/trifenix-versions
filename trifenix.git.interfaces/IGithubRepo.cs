...
namespace trifenix.git.interfaces
{
    ...
    public interface IGithubRepo<T>
    {
        ...
        /// <param name="branch">ramaRama de la que obtendrá el elemento (por defecto es master)</param>
        void SaveFile(string path, string message, T element, string branch = "master");
        ...
        T GetElement(string path, bool force = false, string branch = "master");
    ...
    public interface IGithubRepo {
        ...
        void Commit(string branch, Dictionary<string, Func<bool>> commitMessageFileOperations);
